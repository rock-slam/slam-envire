...
{  
  ...
  void copyGridToGrid(envire::Grid<T1> &grid1, envire::Grid<T2> &grid2,float scale)
  {
     typename envire::Grid<T1>::ArrayType &data1 = grid1.getGridData();
     typename envire::Grid<T2>::ArrayType &data2 = grid2.getGridData("elevation");
